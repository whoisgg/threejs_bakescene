...
export type PreprocessorIfPart = PreprocessorIfNode | PreprocessorIfDefNode | PreprocessorIfndefNode;
...
export type PreprocessorAstNode = PreprocessorBinaryNode | PreprocessorConditionalNode | PreprocessorDefineArgumentsNode | PreprocessorDefineNode | PreprocessorElseNode | PreprocessorElseIfNode | PreprocessorErrorNode | PreprocessorExtensionNode | PreprocessorGroupNode | PreprocessorIdentifierNode | PreprocessorIfNode | PreprocessorIfDefNode | PreprocessorIfndefNode | PreprocessorIntConstantNode | PreprocessorLineNode | PreprocessorLiteralNode | PreprocessorPragmaNode | PreprocessorSegmentNode | PreprocessorTextNode | PreprocessorUnaryDefinedNode | PreprocessorUnaryNode | PreprocessorUndefNode | PreprocessorVersionNode;
